...
export const TestimonialSlider = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-[650px] md:min-h-[600px] overflow-hidden bg-white text-black p-8 md:p-12",
        className
      )}
    >
      <div className="text-center mb-16">
                  <h2 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-[#AB8C95] via-[#000000] to-[#8E97C5]">User Reviews</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full">
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
          ...
          {/* Navigation Buttons */}
          <div className="flex items-center text-white space-x-2 mt-8 md:mt-0">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-12 h-12 bg-black cursor-pointer border-muted-foreground/50"
              onClick={handlePrev}
