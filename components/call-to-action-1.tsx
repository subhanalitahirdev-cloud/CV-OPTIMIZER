export default function CallToAction() {
    return (
        <>
            ...
            <div className="max-w-5xl py-16 md:w-full mx-2 md:mx-auto flex flex-col items-center justify-center text-center bg-linear-to-b from-[#5524B7] to-[#380B60] rounded-2xl p-12 mb-10 mt-5 text-white">
                <div className="flex flex-wrap items-center justify-center p-1 rounded-full bg-purple-600/10 backdrop-blur border border-purple-500/40 text-sm">
                    ...
                    <p className="-translate-x-2 font-medium">Ready to Land Your Next Job? </p>
                </div>
                <h1 className="text-4xl md:text-5xl md:leading-[60px] font-semibold max-w-xl mt-5 bg-linear-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">“Start optimizing your CV for free and get instant feedback.</h1>
