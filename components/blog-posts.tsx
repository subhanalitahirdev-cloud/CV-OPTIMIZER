...
export const Component = ({
  ...
  return (
    <section className={cn(
      ...
      <h1 className="text-center text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-[#AB8C95] via-[#000000] to-[#8E97C5]">
        {title}
      </h1>
      ...
      {backgroundLabel && (
        <span
          className={cn(
            "absolute -top-10 -z-50 select-none text-[180px] font-extrabold leading-none text-black/3 md:text-[250px] lg:text-[400px]",
      ...
      <p className="mx-auto max-w-[800px] text-center text-xl leading-loose! text-black/60 md:text-2xl mb-8">
        {description}
      </p>
      ...
      <div className="grid h-auto grid-cols-1 gap-5 md:h-[650px] md:grid-cols-2 lg:grid-cols-[1fr_0.5fr]">
        {posts.map((post, index) => {
          ...
          return (
            ...
            >
              <div className="absolute inset-0 z-0 h-[130%] w-full bg-linear-to-t from-black/80 to-transparent transition-all duration-500 group-hover:h-full" />
